...
kafka_producer.py
─────────────────
Module Kafka producer singleton dành cho ml-platform-service.
...
async def publish_surge_updated(zone_id: str, surge_multiplier: float, updated_at: str, source: str = "ml-platform") -> None:
    """
    ...
    Args:
        ...
        source: Nguồn tính surge (mặc định "ml-platform")
    """
    if not _producer:
