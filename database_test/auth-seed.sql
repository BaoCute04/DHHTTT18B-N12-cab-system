...
VALUES (
  '1b754468-8f4c-4cd9-b4d8-6923316625ae', 
  'f4f1bf52-6c73-42a1-8098-8bb47d9db828', -- Đây là userId sẽ dùng xuyên suốt
  '0909123456', 
  'phone', 
  'active'
...
VALUES (
  ...
  'd24b3038-f1ab-4ab2-9e9d-16be02bd5eb2', 
  '0909000999', 
  'phone', 
  'active'
) ON CONFLICT (id) DO NOTHING;
...
VALUES (
  'd99636a4-6d9a-4328-b21d-decd8bbb81e1', 
